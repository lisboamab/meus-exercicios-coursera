...
"""
import math
pontoUmX = float(input("Digite o X do ponto 1: "))
pontoUmY = float(input("Digite o Y do ponto 1: "))
pontoDoisX = float(input("Digite o X do ponto 2: "))
pontoDoisY = float(input("Digite o Y do ponto 2: "))
distancia = math.sqrt(((pontoUmX - pontoDoisX)**2 + (pontoUmY - pontoDoisY)**2))
if distancia >= 10:
    print("longe")
else:
    print("perto")